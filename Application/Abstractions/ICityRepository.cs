...
public interface ICityRepository
{
    ...
    Task<IReadOnlyList<City>> GetPagedAsync(int page, int pageSize, string? search, CancellationToken ct = default);
    ...
    Task<bool> ExistsAsync(string name, int regionId, CancellationToken ct = default);
}
