...
public interface IPersonRepository
{
    ...
    Task<IReadOnlyList<Person>> GetPagedAsync(int page, int pageSize, string? search, CancellationToken ct = default);
    ...
    Task<bool> ExistsAsync(int documentTypeId, string documentNumber, CancellationToken ct = default);
}
