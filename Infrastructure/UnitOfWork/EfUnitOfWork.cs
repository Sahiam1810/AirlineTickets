...
public class EfUnitOfWork : IUnitOfWork
{
    ...
    public IReservationRepository Reservations
    {
        get
        {
            ...
            {
                _reservation = new ReservationRepository(_contextdb);
            }
    ...
    public IReservationFlightRepository ReservationFlights
    {
        get
        {
            if (_reservationFlight == null)
            {
                _reservationFlight = new ReservationFlightRepository(_contextdb);
            }
    ...
    public ICheckInRepository CheckIns
    {
        get
        {
            if (_checkIn == null)
            {
                _checkIn = new CheckInRepository(_contextdb);
            }
    ...
    public IInvoiceRepository Invoices
    {
        get
        {
            if (_invoice == null)
            {
                _invoice = new InvoiceRepository(_contextdb);
            }
    ...
    public IInvoiceItemRepository InvoiceItems
    {
        get
        {
            ...
            {
                _invoiceItem = new InvoiceItemRepository(_contextdb);
            }
